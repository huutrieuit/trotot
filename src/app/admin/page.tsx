...
import { ListChecks, Users, LayoutDashboard, PlusSquare, TrendingUp, Clock, Settings } from "lucide-react";
...
export default async function AdminPage() {
  ...
  const stats = [
    ...
    { label: "Chờ duyệt", value: pendingListings ?? 0, icon: Clock, color: "text-amber-600", bg: "bg-amber-50", href: "/admin/duyet-tin" },
    { label: "Đang hiển thị", value: activeListings ?? 0, icon: TrendingUp, color: "text-green-600", bg: "bg-green-50" },
    { label: "Người dùng", value: totalUsers ?? 0, icon: Users, color: "text-purple-600", bg: "bg-purple-50", href: "/admin/users" },
  ];
