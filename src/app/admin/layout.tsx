...
import { ShieldCheck, LayoutDashboard, PlusSquare, ListChecks, Users, LayoutList, Zap, UserCog, PhoneOff, Flag, BarChart2 } from "lucide-react";
import { createClient } from "@/lib/supabase/server";

const ALL_NAV = [
  { href: "/admin",                icon: LayoutDashboard, label: "Tổng quan",      adminOnly: false },
  { href: "/admin/thong-ke",       icon: BarChart2,       label: "Thống kê",        adminOnly: false },
