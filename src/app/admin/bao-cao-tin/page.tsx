...
import ListingReportCard from "./ListingReportCard";
...
export default async function ListingReportsPage() {
  ...
  const { data: reports } = await supabase
    ...
    .select("id, reason, status, created_at, user_id, listing_id, listings(id, title, address, city)")
    .eq("status", "pending")
  ...
  return (
    <div className="max-w-3xl mx-auto px-4 py-6">
      <div className="flex items-center gap-3 mb-6">
        ...
        <div>
          <h1 className="text-xl font-bold text-gray-900">Báo cáo tin giả</h1>
