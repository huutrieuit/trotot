...
export default function DangKyForm({ ssoOnly }: Props) {
              ...
              <div className="grid grid-cols-2 gap-3">
                <button
                  ...
                  className={cn(
                    ...
                    role === "tenant" ? "border-blue-500 bg-blue-50" : "border-gray-200 bg-white hover:border-gray-300"
                  )}
                >
                ...
                <button
                  ...
                  className={cn(
                    "flex flex-col items-center gap-1.5 p-4 rounded-2xl border-2 transition-all",
                    role === "landlord" ? "border-orange-500 bg-orange-50" : "border-gray-200 bg-white hover:border-gray-300"
                  )}
                >
